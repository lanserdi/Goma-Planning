(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["planning"] = factory();
	else
		root["planning"] = factory();
...
class Planning {
    ...
    createAddTaskComponent() {
        ...
        this.eleSendTask.addEventListener('click', e => {
            this.onClickSendTask(e);
        }, false);
    }
    onClickSendTask(e) {
        this.showLoading();
...
/* harmony export (immutable) */ __webpack_exports__["Planning"] = Planning;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["dealDateNumber"] = dealDateNumber;
